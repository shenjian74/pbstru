...
void constru_message_Hello_191120085222(st_hello* var_Hello) {
    var_Hello->var_id = 0;
...
void clear_message_Hello_191120085222(st_hello* var_Hello) {
    var_Hello->var_id = 0;
    var_Hello->var_flt = 0.0;
    var_Hello->var_str.length = 0;
    var_Hello->var_str.data = NULL;
...
void _clear_message_Hello_len_191120085222(st_hello* var_Hello) {
    var_Hello->_message_length = 0;
}

size_t _internal_encode_message_Hello_191120085222(st_hello* var_Hello, BYTE* buf) {
    size_t offset = 0;

    /* tag:1 type:int32 */
    TEST_encode_tag_byte_191120085222(buf, 1, WIRE_TYPE_VARINT, &offset);
    encode_varint(var_Hello->var_id, buf, &offset);

    /* tag:2 type:float */
    TEST_encode_tag_byte_191120085222(buf, 2, WIRE_TYPE_FIX32, &offset);
    if(NULL != buf) {
    ...
    /* tag:3 type:string */
    TEST_encode_tag_byte_191120085222(buf, 3, WIRE_TYPE_LENGTH_DELIMITED, &offset);
    ...
    if(var_Hello->has_opt) {
        /* tag:4 type:int32 */
        TEST_encode_tag_byte_191120085222(buf, 4, WIRE_TYPE_VARINT, &offset);
...
size_t encode_message_Hello_safe_191120085222(st_hello* var_Hello, BYTE* buf, size_t buf_size) {
    _clear_message_Hello_len_191120085222(var_Hello); 

    if (_internal_encode_message_Hello_191120085222(var_Hello, NULL) > buf_size) {
        return 0;
    }
    return _internal_encode_message_Hello_191120085222(var_Hello, buf);
}


BOOL decode_message_Hello_191120085222(BYTE* buf, const size_t buf_len, st_hello* var_Hello) {
    size_t offset = 0;
    WORD field_num;
    BYTE wire_type;
    ...
    for(;offset < buf_len;) {
        if(FALSE == TEST_parse_tag_byte_191120085222(buf+offset, buf_len-offset, &field_num, &wire_type, &offset)) {
            return FALSE;
        }
        switch(field_num) {
        case 1:  /* type:int32 */
