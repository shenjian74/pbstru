...
/* 对tag信息进行编码 */
#define TEST_encode_tag_byte(buf, tag, wire_type, offset) TEST_encode_tag_byte_191120085222((buf), (tag), (wire_type), (offset))
void TEST_encode_tag_byte_191120085222(BYTE *buf, const BYTE tag, const BYTE wire_type, size_t *offset);

#define TEST_parse_tag_byte(buf, buflen, field_num, wire_type, offset) TEST_parse_tag_byte_191120085222((buf), (buflen), (field_num), (wire_type), (offset))
