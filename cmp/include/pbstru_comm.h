...
#define encode_tag_byte(buf, tag, wire_type, offset) encode_tag_byte_191230025720((buf), (tag), (wire_type), (offset))
void encode_tag_byte_191230025720(BYTE *buf, const BYTE tag, const BYTE wire_type, size_t *offset);

#define parse_tag_byte(buf, buflen, field_num, wire_type, offset) parse_tag_byte_191230025720((buf), (buflen), (field_num), (wire_type), (offset))
