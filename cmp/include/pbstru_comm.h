...
/* 对tag信息进行编码 */
#define TEST_encode_tag_byte(buf, tag, wire_type, offset) TEST_encode_tag_byte_191120024546((buf), (tag), (wire_type), (offset))
void TEST_encode_tag_byte_191120024546(BYTE *buf, const BYTE tag, const BYTE wire_type, size_t *offset);

#define TEST_parse_tag_byte(buf, buflen, field_num, wire_type, offset) TEST_parse_tag_byte_191120024546((buf), (buflen), (field_num), (wire_type), (offset))
BOOL TEST_parse_tag_byte_191120024546(const BYTE* buf, const size_t buflen, WORD *field_num, BYTE *wire_type, size_t *offset);

inline void encode_varint(unsigned long long value, BYTE *buf, size_t *offset) __attribute__((always_inline));
/* 对varint信息进行解码 */
