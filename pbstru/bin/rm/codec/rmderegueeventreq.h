...
#define PBSTRU_MAX_SRVTYPE_IN_RMDEREGUEEVENTREQ 10
...
typedef struct _st_srvtype_in_rmderegueeventreq_uint32_list {
    size_t count;
    DWORD item[PBSTRU_MAX_SRVTYPE_IN_RMDEREGUEEVENTREQ];  /* tag:3 type:uint32 */
} st_srvtype_in_rmderegueeventreq_uint32_list;

typedef struct _st_rmderegueeventreq {
    ps_bytes var_primary;  /* tag:1 */
    st_event_in_rmderegueeventreq_rmevent_list var_event;  /* tag:2 */
    st_srvtype_in_rmderegueeventreq_uint32_list var_srvtype;  /* tag:3 */
